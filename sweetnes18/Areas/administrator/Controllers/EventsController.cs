...
namespace sweetnes18.Areas.administrator.Controllers
{
    ...
    public class EventsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,StartDate,EndDate,Description,status")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,StartDate,EndDate,Description,status")] Event @event)
        {
            if (ModelState.IsValid)
            {
